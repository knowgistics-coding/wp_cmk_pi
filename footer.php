...
<script>
  ...
  function add_credit(v) {
    let parent = $(v).parent();
    let url = $(v).attr("src");
    $('<img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" style="position:absolute;top:0;left:0;width:100%;height:100%" />').insertAfter(v);
